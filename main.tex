...
\begin{frame}{Java: many, many, many options}
\vspace{0.25 cm}
\begin{columns}
\column{1.1\linewidth}
\only<1>{\includegraphics[width=\linewidth]{gcmeasure-java8.pdf}}\only<2>{\includegraphics[width=\linewidth]{gcmeasure-java21.pdf}}\only<3>{\includegraphics[width=\linewidth]{gcmeasure-javaZ.pdf}}\only<4>{\includegraphics[width=\linewidth]{gcmeasure-javaShenandoah.pdf}}\only<5>{\includegraphics[width=\linewidth]{gcmeasure-javaSerial.pdf}}
\end{columns}
\end{frame}
...
\begin{frame}{Julia: very predictable}
\vspace{0.25 cm}
\begin{columns}
\column{1.1\linewidth}
