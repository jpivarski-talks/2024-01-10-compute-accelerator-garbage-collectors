...
\item<5-> Julia's garbage collector is generational (2), not compacting, and scales with available memory.
\item<6-> The Julia community considers avoiding heap-allocation a priority.
\end{itemize}
\end{frame}
